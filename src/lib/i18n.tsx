...
export const translations: Record<string, Record<Language, string>> = {
  ...
  "Gross Sales": { en: "Gross Sales", hi: "कुल बिक्री" },
  "Collected": { en: "Collected", hi: "एकत्रित" },
  "Net Earnings": { en: "Net Earnings", hi: "शुद्ध कमाई" },
  "Pending Khata": { en: "Pending Khata", hi: "बकाया खाता" },
  "Expected Cash": { en: "Expected Cash", hi: "अपेक्षित नकद" },
  "Total Bills": { en: "Total Bills", hi: "कुल बिल" },
  "Dish-wise Sales": { en: "Dish-wise Sales", hi: "डिश-वार बिक्री" },
  "Dish": { en: "Dish", hi: "डिश" },
  "Qty Sold": { en: "Qty Sold", hi: "बेची मात्रा" },
  "Amount": { en: "Amount", hi: "राशि" },
  "dishes": { en: "dishes", hi: "डिशें" },
  "bills": { en: "bills", hi: "बिल" },
  "expenses": { en: "expenses", hi: "खर्च" },
  "No sales in this period.": {
    en: "No sales in this period.",
    hi: "इस अवधि में कोई बिक्री नहीं।",
  },
  ...
  "Service Charge": { en: "Service Charge", hi: "सर्विस चार्ज" },
  "Tax / GST": { en: "Tax / GST", hi: "टैक्स / GST" },
  "GRAND TOTAL": { en: "GRAND TOTAL", hi: "कुल योग" },
  "Payment Mode": { en: "Payment Mode", hi: "भुगतान तरीका" },
  "Scan & Pay via UPI": { en: "Scan & Pay via UPI", hi: "UPI से स्कैन और भुगतान" },
  "Free Guest Wi-Fi": { en: "Free Guest Wi-Fi", hi: "मुफ़्त गेस्ट Wi-Fi" },
  "Network": { en: "Network", hi: "नेटवर्क" },
  "UDHAAR (UNPAID)": { en: "UDHAAR (UNPAID)", hi: "उधार (बकाया)" },
  "Dine-In": { en: "Dine-In", hi: "डाइन-इन" },
  "Takeaway": { en: "Takeaway", hi: "टेकअवे" },
  "TAX INVOICE / BILL": { en: "TAX INVOICE / BILL", hi: "टैक्स इनवॉइस / बिल" },
  "KITCHEN ORDER TOKEN (KOT)": {
    en: "KITCHEN ORDER TOKEN (KOT)",
    hi: "किचन ऑर्डर टोकन (KOT)",
  },
  "ITEM DESCRIPTION": { en: "ITEM DESCRIPTION", hi: "आइटम विवरण" },
  "Order": { en: "Order", hi: "ऑर्डर" },
  "Type": { en: "Type", hi: "प्रकार" },
  "Note": { en: "Note", hi: "नोट" },
  "*** END OF KITCHEN ORDER ***": {
    en: "*** END OF KITCHEN ORDER ***",
    hi: "*** किचन ऑर्डर समाप्त ***",
  },
  ...
  "Bill Ready — auto-prints": {
    en: "Bill Ready — auto-prints",
    hi: "बिल तैयार — अपने आप प्रिंट",
  },
  "Auto-printed": { en: "Auto-printed", hi: "ऑटो-प्रिंट हो गया" },
  "Auto-printing…": { en: "Auto-printing…", hi: "ऑटो-प्रिंट…" },
